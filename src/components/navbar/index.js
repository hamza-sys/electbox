...
const Navbar = () => {
  ...
  const [isMax430, isMax500, isMax740, isMin980] = useMediaQuery([
    "(max-width: 430px)",
    "(max-width: 500px)",
    "(max-width: 740px)",
    "(min-width: 980px)",
  ...
  return (
    <Box borderBottom="1px solid #686868">
      {toggleSearch === "navbar" ? (
          ...
          <Flex justify="space-between">
            ...
            {isMin980 ? (
              <HStack w="37%">
                ...
                />
                <Button bg="#fdda06" _hover={{ bg: "#edcd07" }} px={7}>
                  Search
                </Button>
              </HStack>
            ) : (
            ...
            <HStack spacing={isMax740 ? 1 : 6}>
              ...
              <IconCom
                icon={<FaRegUser />}
                text={isMax740 ? null : "Account"}
              />
              {!isMax430 ? (
                <>
                  <IconCom
                    icon={<FaRegHeart />}
                    text={isMax740 ? null : "Wishlist"}
                    badge={3}
                  />
                  <IconCom
                    icon={<BsArrowRepeat />}
                    text={isMax740 ? null : "Compare"}
                    badge={4}
                  />
                </>
              ) : (
